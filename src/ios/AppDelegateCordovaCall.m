...
- (void) applicationDidBecomeActive:(UIApplication *)application {
	[[NSNotificationCenter defaultCenter] postNotificationName:@"com.nfon.applicationstate.isBackground" object:self userInfo:@{ @"isBackground": @NO }];
}

- (void) applicationWillResignActive:(UIApplication *)application {
	[[NSNotificationCenter defaultCenter] postNotificationName:@"com.nfon.applicationstate.isBackground" object:self userInfo:@{ @"isBackground": @YES }];}
